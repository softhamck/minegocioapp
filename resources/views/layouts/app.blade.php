...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'MiNegocioApp') }} - Administrador</title>
    ...
    <body class="admin-bg min-h-screen font-sans antialiased text-[#1F2937]">
                        ...
                        <div class="flex items-center justify-between gap-4">
                            ...
                            <nav class="hidden items-center gap-2 sm:flex">
                                <x-nav-link
                                    ...
                                    class="nav-link-soft rounded-full px-4 py-2 text-sm font-medium {{ request()->routeIs('dashboard') ? 'nav-link-active' : '' }}"
                                >
                                    Dashboard
                                </x-nav-link>
                                ...
                                @if(Auth::user()->rol_id == 1)
                                    <x-nav-link
                                        ...
                                        class="nav-link-soft rounded-full px-4 py-2 text-sm font-medium {{ request()->routeIs('admin.users.*') ? 'nav-link-active' : '' }}"
                                    >
                                        Usuarios
                                    </x-nav-link>
                                    ...
                                    <x-nav-link
                                        ...
                                        class="nav-link-soft rounded-full px-4 py-2 text-sm font-medium {{ request()->routeIs('admin.orders.*') ? 'nav-link-active' : '' }}"
                                    >
                                        Pedidos
                                    </x-nav-link>
                                    ...
                                    <x-nav-link
                                        ...
                                        class="nav-link-soft rounded-full px-4 py-2 text-sm font-medium {{ request()->routeIs('admin.products.*') ? 'nav-link-active' : '' }}"
                                    >
                                        Productos
                                    </x-nav-link>
                                @endif
                                    ...
                                    <x-slot name="content">
                                        <div class="rounded-2xl border border-[#F3E8FF] bg-white/95 p-2 shadow-[0_18px_40px_rgba(124,58,237,0.12)] backdrop-blur-xl">
                                            <div class="px-3 py-2">
                                                ...
                                                <p class="text-xs text-[#9CA3AF]">Administrador</p>
                                            </div>

                                            <div class="my-2 border-t border-[#F3E8FF]"></div>

                                            <x-dropdown-link :href="route('dashboard')" class="rounded-xl px-3 py-2 text-sm text-[#6B7280] hover:bg-[#FAF5FF] hover:text-[#7C3AED]">
                                                Dashboard
                                            </x-dropdown-link>

                                            @if(Auth::user()->rol_id == 1)
                                                <x-dropdown-link :href="route('admin.users.index')" class="rounded-xl px-3 py-2 text-sm text-[#6B7280] hover:bg-[#FAF5FF] hover:text-[#7C3AED]">
                                                    Usuarios
                                                </x-dropdown-link>

                                                <x-dropdown-link :href="route('admin.orders.index')" class="rounded-xl px-3 py-2 text-sm text-[#6B7280] hover:bg-[#FAF5FF] hover:text-[#7C3AED]">
                                                    Pedidos
                                                </x-dropdown-link>
