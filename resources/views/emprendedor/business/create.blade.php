<x-emprendedor-layout>
    <x-slot name="header">
        <div class="flex items-center space-x-3">
            <div>
                <h2 class="text-xl font-semibold text-[#1F2937]">Crear Nuevo Negocio</h2>
                <p class="text-sm text-[#6B7280]">Completa la información de tu nuevo establecimiento</p>
            </div>
        </div>
    </x-slot>
                ...
                <div class="relative p-6 sm:p-8">
                    ...
                    <form action="{{ route('emprendedor.business.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            @enderror
                            <p class="mt-1 text-xs text-[#6B7280]">El nombre debe ser único y representativo de tu negocio</p>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex justify-between">
                                ...
                                <span id="charCount" class="text-xs text-[#6B7280]">0/500</span>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 pt-6 border-t border-[#F3E8FF]">
                            <button 
                                type="submit"
                                class="flex-1 rounded-full bg-gradient-to-r from-[#7C3AED] to-[#F472B6] px-8 py-3 font-semibold text-white transition-all duration-300 hover:from-[#6D28D9] hover:to-[#EC4899] hover:shadow-[0_12px_30px_rgba(124,58,237,0.25)] flex items-center justify-center"
                            >
                            ...
                            <a 
                                ...
                                class="flex-1 rounded-full border border-[#E9D5FF] bg-white/80 px-8 py-3 text-center font-semibold text-[#374151] transition-all duration-300 hover:bg-[#FAF5FF] hover:text-[#7C3AED] flex items-center justify-center"
                            >
                                <svg class="mr-2 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="relative overflow-hidden rounded-2xl border border-white/60 bg-white/70 p-6 mt-6 backdrop-blur">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    <div class="flex items-start space-x-3">
                        ...
                        <p class="text-[#6B7280]">Usa un nombre memorable y fácil de recordar para tus clientes</p>
                    </div>
                    <div class="flex items-start space-x-3">
                        <div class="mt-0.5 flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-full bg-gradient-to-r from-[#7C3AED]/20 to-[#F472B6]/20">
                            <span class="text-xs font-bold text-[#7C3AED]">2</span>
                        </div>
                        <p class="text-[#6B7280]">Sé claro en la descripción sobre lo que ofrece tu negocio</p>
                    </div>
                    <div class="flex items-start space-x-3">
                        <div class="mt-0.5 flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-full bg-gradient-to-r from-[#7C3AED]/20 to-[#F472B6]/20">
                            <span class="text-xs font-bold text-[#7C3AED]">3</span>
                        </div>
                        <p class="text-[#6B7280]">Incluye un teléfono activo para que los clientes te contacten</p>
                    </div>
                    <div class="flex items-start space-x-3">
                        <div class="mt-0.5 flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-full bg-gradient-to-r from-[#7C3AED]/20 to-[#F472B6]/20">
